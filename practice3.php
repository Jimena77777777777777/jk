...
<head>
    ...
    <script>
        function toggleCantidad() {
            ...
            // Muestra u oculta la caja de texto según la opción seleccionada
            cantidadInput.style.display = (lista.value == "6" || lista.value == "7") ? "table-row" : "none";
        }
    </script>
</head>
<body>
    ...
    <section>
        ...
        <form method="get" action="" onsubmit="toggleCantidad()">
        <?php
            error_reporting(0);
            ...
            switch ($lista3) {
                ...
                case 6:
                    ...
                    if ($cantidad > 0) {
                        ...
                        $resultado = !empty($valoresArray) ? max($valoresArray) : 'No se ingresaron valores para calcular el mínimo.';
                    } else {
            ...
            <tr id="cantidadInput" style="display: none;">
